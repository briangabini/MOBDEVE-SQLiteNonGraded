...
class MyDbHelper(context: Context?) : SQLiteOpenHelper(context, DbReferences.DATABASE_NAME, null, DbReferences.DATABASE_VERSION) {
    ...
    fun insertContact(c: Contact): Long {
        ...
        val resultId = database.insert(DbReferences.TABLE_NAME, null, values)
        database.close()
    ...
    /*
     *  DONE: Create methods for deleting and editing of a contact. Then call these methods in the
    ...
    fun editContact(contact: Contact) {
        ...
        val values = ContentValues()
        values.put(DbReferences.COLUMN_NAME_LAST_NAME, contact.lastName)
        values.put(DbReferences.COLUMN_NAME_FIRST_NAME, contact.firstName)
        values.put(DbReferences.COLUMN_NAME_NUMBER, contact.number)
        values.put(DbReferences.COLUMN_NAME_IMAGE_URI, contact.imageUri)
